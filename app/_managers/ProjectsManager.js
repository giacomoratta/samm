const ProjectsHistory = require('./project.modules/ProjectsHistory.class')
const ProjectsTemplate = require('./project.modules/ProjectsTemplate.class')
const ProjectsPath = require('./project.modules/ProjectsPath.class')
...
class ProjectsManager {
  ...
  save () {
    return dataFileHolder.save('projects')
  }
