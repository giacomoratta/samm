...
cliMgr.addCommandBody(cmd_name, function (cliReference, cliNextCb, cliData) {
  ...
  const C_coverage_options = {
    path: null, // custom path
    query: null, // query tags
    tag: '', // query tags

    allinfo: cliData.cliInput.hasOption('allinfo'),
    progressive: cliData.cliInput.hasOption('progressive')
  }

  /* PATH */
  C_coverage_options.path = cliData.cliInput.getOption('path')
  ...
  /* QUERY */
  C_coverage_options.query = cliData.cliInput.getOption('query')
  C_coverage_options.tag = cliData.cliInput.getOption('tag')
  ...
  // Check Coverage
  const cv_output = SamplesMgr.checkSamplesCoverage(C_coverage_options)
  ...
  const showUncoverageOutput = (showuncovered) => {
